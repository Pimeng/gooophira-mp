...
log-agent-outbox-unavailable = Agent outbox unavailable: { $error }
log-agent-outbox-shutdown-failed = Failed to shut down Agent outbox: { $error }
log-agent-ipc-unavailable = Agent IPC unavailable: { $error }
log-agent-ipc-listen = Agent IPC listening on { $addr }
log-agent-ipc-shutdown-failed = Failed to shut down Agent IPC: { $error }
log-agent-stopped = Agent stopped: { $error }
log-agent-config-not-found = Agent config file not found at { $path }; using an empty configuration
log-agent-load-config-failed = Failed to load Agent configuration: { $error }
log-agent-open-inbox-failed = Failed to open Agent inbox: { $error }
log-agent-open-webhook-ledger-failed = Failed to open Agent Webhook ledger: { $error }
log-agent-open-webhook-processor-failed = Failed to open Agent Webhook processor: { $error }
log-agent-open-stats-failed = Failed to open Agent stats database: { $error }
log-agent-open-stats-processor-failed = Failed to open Agent stats processor: { $error }
log-agent-stats-cleanup-failed = Failed to clean up Agent stats: { $error }
log-agent-stats-vacuum-failed = Failed to vacuum Agent stats database: { $error }
log-agent-open-upload-failed = Failed to open Agent replay upload store: { $error }
log-agent-open-upload-processor-failed = Failed to open Agent replay upload processor: { $error }
log-agent-legacy-config-flag = `-webhook-config` is deprecated; use `-config`
log-agent-legacy-config-file = Config file { $path } is deprecated; move it to { $target }
log-agent-discovery-unavailable = Agent cannot read the server discovery file: { $error }
log-agent-connected = Connected to server { $server } using Agent protocol v{ $version }
log-agent-server-connection-lost = Agent lost the server connection: { $error }
log-pprof-start-failed = Failed to start pprof diagnostics: { $error }
log-pprof-listen = pprof diagnostics listening on { $addr }
log-pprof-shutdown-failed = Failed to shut down pprof diagnostics: { $error }
